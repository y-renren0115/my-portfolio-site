  ...
  return (
    <div className="max-w-2xl mx-auto p-8 text-center font-alice">
      ...
      <div className="flex justify-center gap-4 mb-8">
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="px-3">
          <FontAwesomeIcon icon={faFacebook} size="2x" />
        </a>
        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="px-3">
          <FontAwesomeIcon icon={faTwitter} size="2x" />
        </a>
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="px-3">
      ...
      <form className="space-y-6" >
        ...
        <button type="submit" className="px-4 py-2 bg-gray-800 text-white rounded hover:bg-blue-700">Submit</button>
      </form >
    </div >
  );
};
